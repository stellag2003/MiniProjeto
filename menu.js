...
import { relatorioAlunos, calculaMediaALuno, calculaMediaGeral, calculaMaiorMedia, relatorioAlunosAprovados, relatorioAlunosReprovados, relatorioAlunosRecuperacao } from './relatorios.js';
    ...
    /*
    -Menu
    -essa função mostra ao usuário as opções que o sistema tem
    -após isso, há verificações da opção escolhida
    -o usuário será redirecionado para diferentes funções de acordo com a opção que ele escolher
    -isso é feito usando o switch case, que aceita letras maiúsculas e minúsculas, porque é usado um toLowerCase, pra converter a resposta do usuário
    -caso o usuário digite 0 o programa é encerrado
    -caso o usuário digite uma opção inválida, é exibida uma mensagem de erro e o menu é mostrado novamente
    */
    export function menu(){
        console.log(chalk.yellowBright("===== Menu Notas e Feitiços ====="));
        console.log(chalk.greenBright("1 - Cadastrar novo bruxo-aluno"));
        console.log("2 - Relatório de bruxos-alunos");
        console.log("3 - Buscar bruxo-aluno");
        console.log("4 - Média individual");
        console.log("5 - Média geral");
        console.log("6 - Aluno Destaque da Grifinória");
        console.log("7 - Aprovados");
        console.log("8 - Reprovados");
        console.log("9 - Recuperação");
        console.log(chalk.greenBright("D - Deletar bruxo-aluno"));
        console.log(chalk.greenBright("A - Atualizar bruxo-aluno"));
        console.log(chalk.redBright("0 - Sair do programa mágico"));
